---
title: Story
description: How Reactor was born. The motivation behind building a hytale-server from scratch.
---
...
From the age of 14, building bored me and I started getting interested in programming. It all started because I was immature enough to grief the very server that had given me an opportunity (sorry davodamc, [tagelis](https://www.youtube.com/@tagelis), and kingscraft). That guilt made me want to learn Java; I started by decompiling Spigot plugins and trying to add more features to them on my own.
